...
function (_PureComponent) {
  ...
  (0, _createClass2.default)(Geocoder, [{
    ...
    value: function render() {
      ...
      }, this.props.inputPosition === 'top' && _react.default.createElement("div", null, input, _react.default.createElement("div", {
        className: this.props.iconLeftClass
      }, _reactFeather.MapPin), _react.default.createElement("div", {
        className: this.props.iconRightClass
      }, _reactFeather.X)), !!this.state.results.length && this.state.isActive && _react.default.createElement("ul", {
      ...
      })), this.props.inputPosition === 'bottom' && _react.default.createElement("div", null, input, _react.default.createElement("div", {
        className: this.props.iconLeftClass
      }, _reactFeather.MapPin), _react.default.createElement("div", {
        className: this.props.iconRightClass
      }, _reactFeather.X)));
...
(0, _defineProperty2.default)(Geocoder, "propTypes", {
  ...
  iconLeftClass: _propTypes.default.string,
  iconRightClass: _propTypes.default.string,
