...
function (_PureComponent) {
  ...
  function Geocoder() {
    ...
    (0, _defineProperty2.default)(_this, "onBlur", function (e) {
      _this.props.onSelect(_this.state.results[_this.state.focus]);
    });
  ...
  (0, _createClass2.default)(Geocoder, [{
    ...
    value: function render() {
      ...
      var input = _react.default.createElement("div", null, _react.default.createElement("input", {
      ...
      }), this.props.showIcons && _react.default.createElement("div", null, _react.default.createElement("div", {
        className: this.props.iconLeftClass
      }, _react.default.createElement(_reactFeather.MapPin, {
        width: 24
